...
function DataKesra() {
  return (
    <>
      <div className='container-fluid bg-white md:py-8 md:pt-20'>
          ...
          <div className='flex flex-col justify-start items-center gap-4 md:gap-8'>
            ...
            <div className='grid grid-cols-2 md:grid-cols-5 gap-8 py-6 md:py-12'>
              {Datas.map((data) => (
                <div
                  key={data.id}
                  className='cols-span-1 bg-primary rounded-xl p-6 flex flex-col justify-start items-center gap-2 opacity-80 hover:opacity-100 transition-all duration-300 ease-in-out'
                >
